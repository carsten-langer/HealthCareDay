    ...
    (shallStop: ShallStop) =>
      (topics: Topics, workshops: Workshops) =>
        (studentsSelectedTopics: StudentsSelectedTopics) =>
          initThenDistribute((shallStop: ShallStop) =>
            distributeUntilStop(shallStop, workshops, studentsSelectedTopics))(shallStop)(topics, workshops)(studentsSelectedTopics)
