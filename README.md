...
__topic__, like _meditation_, _soccer_, _diving_, _cooking_, ... The workshop topic also belongs to a coarser
...
* On average, min. 12 seats per workshop to provide one seat per student per workshop (50 * 12 = 600), but this largely
...
that some form of approximation is needed to find a suboptimal yet good enough distribution.
